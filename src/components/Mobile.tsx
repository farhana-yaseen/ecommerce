  ...
  return (
    ...
    <div className="w-[390px] h-[853px] bg-rectangleColor relative">
      ...
      <div className="flex flex-col justify-center space-y-8 mx-4">
        ...
        <div className="w-[358px] h-[50px] top-[251px] left-4  ">
        ...
        {/* Button */}
        <div className="w-[358px] h-[52px] top-[325px] left-4 px-[54px] py-4 rounded-[62px] bg-black flex justify-center items-center">
