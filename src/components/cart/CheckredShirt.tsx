            ...
            <div className="w-[217px] h-[99px] lg:w-[527px] lg:h-[124px] justify-between">
                ...
                <div className="w-[217px] h-[57px] lg:w-[227px] lg:h-[118px] flex justify-between">
                    ...
                    <div className="w-[181px] h-[57px] gap-1 lg:w-[227px] lg:h-[71px] flex flex-col">
                        {/* Text */}
                        <h1 className="w-[121px] h-[22px] lg:w-[151px] lg:h-[27px] font-figtree font-bold text-base lg:text-[20px] leading-[21.6px] lg:leading-[27px]">Checkred Shirt</h1>

                        <div className="w-[97px] h-[34px] gap-[2px] lg:w-[78px] lg:h-[42px]">
                            <h1 className="w-[58px] h-4 lg:w-[82px] lg:h-[19px] font-figtree font-normal text-xs lg:text-sm leading-[16.2px] lg:leading-[18.19px]">Size:<span className="opacity-60">Medium</span></h1>
                            <h1 className="w-[67px] h-4 lg:w-[82px] lg:h-[19px] font-figtree font-normal text-xs lg:text-sm leading-[16.2px] lg:leading-[18.19px]">Color: <span className="opacity-60"> Red</span></h1>
                        </div>
                    </div>
                ...
                <div className="w-[217px] h-[31px] lg:w-full flex justify-between items-center">
                    ...
                    <div className="w-[45px] h-[27px] lg:w-[54px] lg:h-8">
                        {/* Price */}
                        <h1 className="ont-figtree font-bold text-xl lg:text-2xl leading-[27px]">$180</h1>
                    </div>
