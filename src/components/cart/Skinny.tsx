            ...
            <div className="flex justify-between items-center gap-4">
                ...
                <div className="w-[527px] h-[124px]">
                    ...
                    <div className="w-[150px] h-[118px]">
                        {/* size & color */}
                        <div className="w-[150px] h-[71px] flex flex-col gap-1">
                            {/* Text */}
                            ...
                            <div className="w-[61px] h-8">
                                {/* Price */}
                                <h1 className="font-figtree font-bold text-xl md:text-2xl leading-  [32.4px]">$240</h1>
                            </div>
                    ...
                    <div className="w-[126px] h-[44px] rounded-[62px] px-5 py-3.5 bg-searchColor flex justify-between items-center">
                        ...
                        <div className="w-5 h-5">
                            <div className="top-[2.19px] left-[2.19px]">
                                <Image src={"/cart/plus.png"} alt="Minus" width={16} height={16} className="w-full h-full object-contain"></Image>
                            </div>
                        </div>
