...
const SkinnyFitJeans = () => {
    return (
        <div>
        <div className="lg:hidden w-[330px] h-[99px] ml-[14px] lg:w-[667px] lg:h-[124px] lg:ml-4">
            <div className="flex justify-between items-center ">

                <div className="w-[99px] h-[99px] rounded-[8.66px] lg:w-[124px] lg:h-[124px]">
                    {/* Image */}
                    <Image src={"/arrival/jeans.png"} alt="Skinny Fit Jeans" width={125} height={187} layout="responsive" className=" w-[99px] h-[149px] top-[-25px] left-[-1px] lg:w-full lg:h-full lg:top-[-30.5px] object-cover lg:object-contain rounded-[8.66px]"></Image>
                </div>
