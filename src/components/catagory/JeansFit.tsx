...
const JeansFit = () => {
    return (
         <div className="flex flex-col justify-between gap-1 lg:gap-2 ml-4">
                    ...
                    {/* star & price */}
                    <div className="w-[106px] h-4 top-[701px] left-[202px] gap-[11px] lg:w-[126px] lg:h-[19px] lg:top-[1056px] lg:left-[416px] lg:gap-[13px] flex justify-between items-center">
                        <div className="w-[67px] h-[15.47px] gap-[4.44px] lg:w-[80px] lg:h-[18.49px] lg:gap-[5.31px] flex justify-start items-center">
                            {/* stars */}
                        ...
                        <div className="w-7 h-4 lg:w-[33px] lg:h-[19px]">
                            {/* rate */}
                            <h1 className="font-figtree font-normal text-xs lg:text-sm leading-[16.2px] lg:leading-[18.9px]">3.5<span>/</span><span>5</span></h1>
                        </div>
                    </div>
                    ...
                    <div className="w-[51px] h-[27px] lg:w-[61px] lg:h-[32px]">
                        ...
                        <div className="w-[51px] h-[27px] lg:w-[55px] lg:h-8">
                            <h1 className="font-figtree font-bold text-xl lg:text-2xl leading-[27px] lg:leading-32.4 line-through text-black opacity-40">$260</h1>
                        </div>
