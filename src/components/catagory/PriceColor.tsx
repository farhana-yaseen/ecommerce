    ...
    return (
        <div className="">
            ...
            <div className="lg:w-[247px] lg:h-[27px] gap-5">
                ...
                {/* percentage */}
                <div className="w-[353px] h-[43px] top-[330px] left-[19px] lg:w-[247px] lg:h-[43px] my-5">
                    {/* Image */}
            ...
            <div className="w-[353px] top-[786px] left-[19px] lg:w-[247px] border-[1px] border-black opacity-10 mt-8"></div>
