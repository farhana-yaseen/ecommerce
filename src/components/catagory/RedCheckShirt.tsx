    ...
    return (
         <div className="flex flex-col justify-center gap-1 xl:gap-2 ml-4">
                    ...
                    <div className="w-[172px] h-[174px] top-[491px] left-[202px] rounded-[13.42px] bg-newArravialbg xl:w-[295px] xl:h-[298px] xl:top-[707px] xl:left-[416px] xl:rounded-[20px] overflow-hidden">
                        <Image src={"/arrival/checkshirt.png"} alt="checkred shirt" width={268} height={402} layout="responsive" className="w-[172px] h-[213px] xl:w-full xl:h-full top:[-19px] left-[15px] xl:top-[-51px] object-contain"></Image>
                    </div>
        
                    <div className="w-[120px] h-[22px] top-[675px] left-[202px] xl:w-[161px] xl:h-[27px] xl:top-[1021px] xl:left-[731px]">
                        <h1 className="font-figtree font-bold text-sm xl:text-xl leading-[21.6px] xl:leading-[27px]">Checkered Shirt</h1>
                    </div>
