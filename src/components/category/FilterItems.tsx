...
// getServerSideProps will be executed server-side and pass the fetched data as props
export async function getServerSideProps() {
    const productOfferList = await getProduct()     // call function
    ...
    const categories: string[] = Array.from(new Set(productOfferList.map((cate: Product) => cate.category)))
...
const FilterItems = ({ productOfferList, categories }: { productOfferList: Product[], categories: string[] }) => {
