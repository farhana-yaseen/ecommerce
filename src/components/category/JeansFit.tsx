    ...
    return (
         <div className="flex flex-col justify-center gap-1 xl:gap-2 ml-4">
                    ...
                    <div className="w-[172px] h-[174px] top-[491px] left-[202px] rounded-[13.42px] bg-newArravialbg xl:w-[295px] xl:h-[298px] xl:top-[707px] xl:left-[416px] xl:rounded-[20px] overflow-hidden">
                        <Image src={"/arrival/jeans.png"} alt="Jeans" width={268} height={402} layout="responsive" className="w-[172px] h-[213px] xl:w-full xl:h-full top:[-19px] left-[15px] xl:top-[-51px] object-contain"></Image>
                    </div>
        
                    <div className="w-[120px] h-[22px] top-[675px] left-[202px] xl:w-[161px] xl:h-[27px] xl:top-[1021px] xl:left-[731px]">
                        <h1 className="font-figtree font-bold text-sm xl:text-xl leading-[21.6px] xl:leading-[27px] capitalize">Skinny Fit Jeans</h1>
                    </div>
        
        
                    {/* star & price */}
                    <div className="w-[106px] h-4 top-[701px] left-[202px] gap-[11px] xl:w-[126px] xl:h-[19px] xl:top-[1056px] xl:left-[416px] xl:gap-[13px] flex justify-between items-center">
                        <div className="w-[67px] h-[15.47px] gap-[4.44px] xl:w-[80px] xl:h-[18.49px] xl:gap-[5.31px] flex justify-start items-center">
                            {/* stars */}
                        ...
                        <div className="w-7 h-4 xl:w-[33px] xl:h-[19px]">
                            {/* rate */}
                            <h1 className="font-figtree font-normal text-xs xl:text-sm leading-[16.2px] xl:leading-[18.9px]">3.5<span>/</span><span>5</span></h1>
                        </div>
                    </div>
                    ...
                    <div className="w-[51px] h-[27px] xl:w-[61px] xl:h-[32px]">
                        ...
                        <div className="w-[51px] h-[27px] xl:w-[55px] xl:h-8">
                            <h1 className="font-figtree font-bold text-xl xl:text-2xl leading-[27px] xl:leading-32.4 line-through text-black opacity-40">$260</h1>
                        </div>
