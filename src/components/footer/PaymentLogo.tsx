  ...
  return (
    <div className='flex justify-between items-center p-5'>
        ...
        <div className="w-[281.07px] h-[30.03px] top-[4258px] left-[1059px] gap-3 flex justify-center items-center">
            {/* Logos */}
            <div className="w-[46.61px] h-[30.03px] rounded-[5.38px] border-[0.22px] border-paymentLogo shadow-custom">
                {/* VISA */}
                <Image src={"/paymentLogo/visa.png"} alt="VISA" width={32.54} height={10.51} className="top-[9.94px] ml-[6.91px] object-contain"></Image>
            </div>
