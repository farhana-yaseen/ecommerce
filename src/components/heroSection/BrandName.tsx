...
const BrandName = () => {
  return (
    <div id="brand" className='w-[390px] h-[146px] top-[951px] md:w-[768px] md:h-[80px] lg:w-[1024px] lg:h-[100px] xl:w-[1440px] xl:h-[122px] xl:top-[797px] bg-black flex flex-wrap justify-around items-center'>

        {/* Versace Logo */}
        <div className='lg:w-[166.48px] lg:h-[33.16px] lg:top-[841px] lg:left-[100px] hover:animate-blink'>
        <Image src={"/brandLogo/versace.png"} alt="versace" width={166.45} height={33.16} className="w-[116.74px] h-[23.25px] lg:w-[166.45px] lg:h-[33.16px] top-[991px] ml-4 lg:top-[841px] object-contain"></Image>
         ...
         {/* zara Logo */}
         <div className='top-[990px] left-[166.74px] lg:w-[91px] lg:h-[38px] lg:top-[839px] lg:left-[372.48px] hover:animate-blink'>
        ...
        {/* gucci Logo */}
        <div className='w-[109.39px] h-[25.24px] top-[990.7px] left-[264.55px] lg:w-[156px] lg:h-9 lg:top-[840px] lg:left-[569.48px] hover:animate-blink'>
        ...
        {/* prada Logo */}
        <div className='w-[127px] h-[21px] top-[1037px] left-48 lg:w-[194px] lg:h-8 lg:top-[842px] lg:left-[834.48px] hover:animate-blink'>
        ...
        {/* calvin Logo */}
        <div className="hover:animate-blink">
