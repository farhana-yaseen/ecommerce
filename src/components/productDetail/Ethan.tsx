...
const Ethan = () => {
    return (
        <div className="w-[358px] h-[224.19px] top-[1766px] ml-4 p-6 xl:w-[610px] xl:h-[241.58px] xl:top-[1222px] xl:left-[100px] rounded-[20px]  border-[1px] border-opacity-10 xl:px-8 xl:py-7 gap-[332px] xl:gap-[352px]">
            <div className="w-[310px] h-[196px] gap-[22px] xl:w-[546px] xl:h-[139.58px] xl:flex flex-col justify-betweeb">
                ...
                <div className="w-[310px] h-[196.19px] gap-3 xl:w-[546px] xl:h-[139.58px] xl:gap-[15px] flex flex-col justify-between">
                    ...
                    <div className="flex justify-between items-center">
                        {/* Stars */}
                        <div className="w-[83.23px] h-[19.19px] gap-[5.51px] xl:w-[97.93px] xl:h-[22.58px] xl:gap-[6.49px] flex justify-center items-center">
                    ...
                    <div className="w-[310px] h-[165px] gap-4 xl:w-[522px] xl:h-[102px] xl:gap-3">
                        ...
                        <div className="w-[310px] h-[127px] gap-2 xl:w-[106px] xl:h-6 xl:gap-1">
                            ...
                            <div className="w-[90px] h-[19px] gap-1 xl:w-[118px] xl:h-[15px] flex justify-between items-center">
                                {/* Ethan */}
                                <h1 className="w-[70px] h-3 xl:w-[85px] xl:h-[15px] font-figtree font-bold text-base xl:text-xl leading-[22px]">Ethan R.</h1>
                    ...
                    {/* posted on */}
                    <h1 className="xl:hidden w-[170px] h-[22px] font-figtree font-medium text-sm leading-[22px] opacity-60">Posted on August 16, 2023</h1>

                </div>
                {/* posted on for desktop */}
                <h1 className="hidden xl:block w-[546px] h-[22px] font-figtree font-medium text-base leading-[22px] opacity-60">Posted on August 16, 2023</h1>
            </div>
        </div>
    )
}
