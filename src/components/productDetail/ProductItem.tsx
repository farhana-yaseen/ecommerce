...
const ProductItem =  ({singleProduct}:DetailProps) => {

    return (
        <div className="flex flex-col lg:flex-row-reverse justify-center items-center lg:gap-4 xl:gap-6 mt-5 lg:mt-0">

            {/* Display Image */}
            <div className="w-[358px] h-[290px] top-[157px] left-4 lg:w-[444px] lg:h-[530px] lg:top-[216px] lg:left-[266px] rounded-[20px]">
                <Image src={singleProduct.imageUrl} alt={singleProduct.name} width={444} height={530} className="w-full h-full object-contain"></Image>
            </div>
            ...
            <div className="w-[111px] h-[106px] top-[459px] left-4 border-[1px] border-black lg:w-[152px] lg:h-[167px] lg:top-[216px] lg:left-[100px] rounded-[20px] bg-productbg overflow-hidden">
                <Image src={singleProduct.imageUrl}  alt={singleProduct.name} width={152} height={167} className="w-full h-full object-contain"></Image>
            </div>
            ...
            <div className="w-[112px] h-[106px] top-[459px] left-[139px] lg:w-[152px] lg:h-[168px] lg:top-[397px] lg:left-[100px] rounded-[20px] bg-newArravialbg overflow-hidden">
                <Image src={singleProduct.imageUrl} alt={singleProduct.name} width={152} height={168} className="w-full h-full object-contain"></Image>
            </div>
