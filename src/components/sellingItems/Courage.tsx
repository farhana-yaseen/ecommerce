  ...
  return (
    <div>
       ...
       <div className="w-[198px] h-[20.01px] top-[1720px] left-[230px] lg:w-[295px] lg:h-[298px] lg:top-[1841px] lg:left-[100px] bg-newArravialbg rounded-[13.42px] lg:rounded-[20px]">
            ...
            {/* star & price */}
            <div className="w-[116.2px] h-4 top-[1956.01px] left-[230px] gap-[11px] lg:w-[137.9px] lg:h-[19px] lg:top-[2190px] lg:left-[415px] lg:gap-[13px] flex justify-center items-center">
